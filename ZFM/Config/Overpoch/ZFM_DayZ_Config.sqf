...
ZFM_UNIT_EQUIPMENT_SNIPER_DEADMEAT =[
	...
	["SVD_CAMO","FHQ_RSASS_SD_TAN","FHQ_MSR_SD_DESERT","FHQ_XM2010_SD_DESERT","vil_M110sd"],														// Snipers from FixedLoot. (Random pick)
...
ZFM_UNIT_EQUIPMENT_SNIPER_MEDIUM =[
	...
	["SVD_CAMO","DMR_DZ","m107","SVD_des_EP1","SCAR_H_LNG_Sniper_SD","vil_M21","RH_mistsp"],										// Snipers from FixedLoot. (Random pick)
...
ZFM_UNIT_EQUIPMENT_SNIPER_HARD =[
	...
	["SCAR_H_LNG_Sniper_SD","SVD_CAMO","DMR_DZ","vil_M110","VIL_SVU_A","VSS_vintorez","vil_SV_98_69","vil_SVD_P21","m8_sharpshooter","vil_SVD_M","vil_SV_98_69","vil_G3SG1","vil_G3sg1b","vil_M24b","vil_M21","vil_SR25","vil_M21G","vil_SVU"],						// Snipers from FixedLoot. (Random pick)
...
ZFM_UNIT_EQUIPMENT_SNIPER_WAR_MACHINE =[
	...
	["KSVK_DZE","DMR_DZ","m107","FHQ_RSASS_TAN","FHQ_MSR_DESERT","FHQ_XM2010_DESERT","m107_SKN"],				// Will always have an awesome sniper rifle..
	5,
...
ZFM_UNIT_EQUIPMENT_RIFLEMAN_DEADMEAT =[
	"Bandit1_DZ", 												// Skin
	["AK_47_M","AK_74","AKS_74_kobra","AKS_74_U","G36C","G36K_camo","M4A1","M249_DZ","vil_AK_74m_EOT_FSB_60","vil_RPD"],														// Snipers from FixedLoot. (Random pick)
	2,																	// Boundary for the maximum number of magazines
	["DZ_ALICE_Pack_EP1","DZ_TK_Assault_Pack_EP1","DZ_British_ACU"],		// Backpacks from FixedLoot (Random pick)
	["ItemBandage","ItemBandage", "ItemPainkiller","ItemKnife","ItemFlashlight"] // Any medical supplies they should require.
];
ZFM_UNIT_EQUIPMENT_RIFLEMAN_EASY =[
	"Bandit1_DZ", 												// Skin
	["AK_47_M","AK_74","AKS_74_kobra","AKS_74_U","G36C","G36K_camo","M4A1","M249_DZ","vil_uzimini","vil_uzi_c","vil_AK_107","vil_AK_105","vil_AK_103","vil_AK_101"],														// Snipers from FixedLoot. (Random pick)
	2,																	// Boundary for the maximum number of magazines
	["DZ_ALICE_Pack_EP1","DZ_TK_Assault_Pack_EP1","DZ_British_ACU"],		// Backpacks from FixedLoot (Random pick)
	["ItemBandage","ItemBandage", "ItemPainkiller","ItemKnife","ItemFlashlight"] // Any medical supplies they should require.
];
ZFM_UNIT_EQUIPMENT_RIFLEMAN_MEDIUM =[
	...
	["AK_47_M","AK_74","AKS_74_kobra","AKS_74_U","G36C","G36K_camo","M4A1","M249_DZ","G36A_camo","G36C_camo","M240_DZ","m8_compact_pmc","vil_AK_107_c","vil_AK_105_c"],										// Snipers from FixedLoot. (Random pick)
	3,																				// Boundary for the maximum number of magazines
	["DZ_ALICE_Pack_EP1","DZ_TK_Assault_Pack_EP1","DZ_British_ACU"],				// Backpacks from FixedLoot (Random pick)
	["ItemBandage","ItemBandage", "ItemPainkiller","ItemKnife","ItemFlashlight"]	
];
ZFM_UNIT_EQUIPMENT_RIFLEMAN_HARD =[
	...
	["AK_47_M","AK_74","AKS_74_kobra","AKS_74_U","G36C","G36K_camo","M4A1","M249_DZ","G36A_camo","G36C_camo","M240_DZ","MG36_camo","RH_m1stacog","FHQ_ACR_WDL_G33","vil_AeK_3_K","vil_AK_74_N","vil_AG3EOT","vil_sg542f","vil_G36VA4Eot","vil_G36E","vil_Galil","vil_RPK75_M72"],						// Snipers from FixedLoot. (Random pick)
	5,																	// Boundary for the maximum number of magazines
	["DZ_ALICE_Pack_EP1","DZ_TK_Assault_Pack_EP1","DZ_British_ACU","DZ_LargeGunBag_EP1"],		// Backpacks from FixedLoot (Random pick)
	["ItemBandage","ItemBandage", "ItemPainkiller","ItemKnife","ItemFlashlight"]
];
ZFM_UNIT_EQUIPMENT_RIFLEMAN_WAR_MACHINE =[
	"Ins_Soldier_GL_DZ",
	["FN_FAL","FN_FAL_ANPVS4","G36A_camo","G36C_camo","M240_DZ","MG36_camo","PK","FHQ_ACR_WDL_TWS"],				// Will always have an awesome sniper rifle..
	5,
	["DZ_ALICE_Pack_EP1","DZ_TK_Assault_Pack_EP1","DZ_British_ACU","DZ_LargeGunBag_EP1"],				// Doesn't really matter.
	["ItemBandage","ItemBandage", "ItemPainkiller","ItemKnife","ItemFlashlight"]
];
...
ZFM_UNIT_EQUIPMENT_COMMANDER_HARD =[
	"GUE_Commander_DZ",
	["FN_FAL","FN_FAL_ANPVS4","SCAR_H_LNG_Sniper_SD","PK","m8_SAW"],				// Will always have an awesome sniper rifle..
	8,
	["DZ_LargeGunBag_EP1"],				// Doesn't really matter.
	["ItemBandage","ItemBandage", "ItemPainkiller","ItemKnife","ItemFlashlight"]
];
...
ZFM_UNIT_EQUIPMENT_HEAVY_HARD =[
	...
	["MG36_camo","M249_DZ","M240_DZ","vil_RPD","skavil_M60","vil_Minimi"],						// Snipers from FixedLoot. (Random pick)
	5,																	// Boundary for the maximum number of magazines
	["DZ_ALICE_Pack_EP1","DZ_TK_Assault_Pack_EP1","DZ_British_ACU","DZ_LargeGunBag_EP1"],		// Backpacks from FixedLoot (Random pick)
	["ItemBandage","ItemBandage", "ItemPainkiller","ItemKnife","ItemFlashlight"]
];
ZFM_UNIT_EQUIPMENT_HEAVY_WAR_MACHINE =[
	"GUE_Soldier_CO_DZ",
	["PK","Vil_RPG7V_PGO"],				// Will always have an awesome rifle..
	5,
	["DZ_ALICE_Pack_EP1","DZ_TK_Assault_Pack_EP1","DZ_British_ACU","DZ_LargeGunBag_EP1"],				// Doesn't really matter.
	["ItemBandage","ItemBandage","ItemPainkiller","ItemKnife","ItemFlashlight"]
];